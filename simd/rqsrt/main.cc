...
void RSqrtKernel(void){
    ...
    for (size_t i = 0; i < ArraySize; i+=56){
        ...
        //b = 1.5 - 0.5xa*a
        b0 = _mm256_fnmsub_ps(three_half, b0, a0);
        b1 = _mm256_fnmsub_ps(three_half, b1, a1);
        b2 = _mm256_fnmsub_ps(three_half, b2, a2);
        b3 = _mm256_fnmsub_ps(three_half, b3, a3);
        b4 = _mm256_fnmsub_ps(three_half, b4, a4);
        b5 = _mm256_fnmsub_ps(three_half, b5, a5);
        b6 = _mm256_fnmsub_ps(three_half, b6, a6);
